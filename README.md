...
ci-reports/0.0.23 darwin-x64 node-v15.6.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src/commands/sfci/coverage.ts](https://github.com/hsaraujo/ci-reports/blob/v0.0.23/src/commands/sfci/coverage.ts)_
...
_See code: [src/commands/sfci/report.ts](https://github.com/hsaraujo/ci-reports/blob/v0.0.23/src/commands/sfci/report.ts)_
<!-- commandsstop -->
